...
function setup() {
  ...
  //Create the Bodies Here.
    ...
    topObj=new roof(width/2,height/4,width/7,20);
    ...
    rope1=new rope(bobObj1.body,topObj.body,-bobDiameter*2,0);
    rope2=new rope(bobObj2.body,topObj.body,-bobDiameter*1,0);
    rope3=new rope(bobObj3.body,topObj.body,0,0);
    rope4=new rope(bobObj4.body,topObj.body,bobDiameter*1,0);
    rope5=new rope(bobObj5.body,topObj.body,bobDiameter*2,0);
...
function keyPressed(){
  if (keyCode === UP_ARROW) {
    Matter.Body.applyForce(bobObj1.body,bobObj2.body.position,{x:-50,y:-45});
  }
}
